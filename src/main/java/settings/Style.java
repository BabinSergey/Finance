...
final public class Style {
    ...
    public static final Color COLOR_BUTTON_BG_NORMAL = new Color(240, 240, 240); // цвет фона кнопки
    public static final Color COLOR_BUTTON_BG_hOVER = new Color(114, 110, 110); // цвет кнопки при наведении
    ...
    public static final Font FONT_BUTTON_TOOLBAR = new Font("Tahoma", Font.BOLD, 14); // стили шрифта в тулбаре

    public static final Font FONT_MAIN_BUTTON = new Font("Tahoma", Font.BOLD, 14); // стили шрифта кнопок
    public static final Font FONT_LABEL_HEADER = new Font("Tahoma", Font.BOLD, 16);
    public static final Font FONT_LABEL_LEFT_PANEL_CURRENCY = new Font("Tahoma", Font.BOLD, 14);
    public static final Font FONT_LABEL_LEFT_PANEL_AMOUNT = new Font("Tahoma", Font.PLAIN, 14);
    public static final Font FONT_TABLE_HEADER = new Font("Tahoma", Font.BOLD, 16);
    public static final Font FONT_TABLE = new Font("Tahoma", Font.PLAIN, 14);
    public static final Font FONT_BUTTON_FILTER = new Font("Tahoma", Font.BOLD, 12);
    public static final int TABLE_ADD_ROW_HEIGHT = 18;

    public static final EmptyBorder BORDER_PANEL = new EmptyBorder(10, 10, 10, 10); // стили рамки
