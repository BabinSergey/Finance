...
public class TransferAddEditDialog extends AddEditDialog {
    ...
    protected void init() {
        ...
        components.put("LABEL_FROM_ACCOUNT", new CommonComboBox(SaveDate.getInstance().getAccounts().toArray()));
        components.put("LABEL_TO_ACCOUNT", new CommonComboBox(SaveDate.getInstance().getAccounts().toArray()));
