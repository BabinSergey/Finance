...
// класс окна по редактированию транзакций
public class TransactionAddEditDialog extends AddEditDialog {
    ...
    protected void init() {
        ...
        components.put("LABEL_ACCOUNT", new CommonComboBox(SaveDate.getInstance().getAccounts().toArray()));
        components.put("LABEL_ARTICLE", new CommonComboBox(SaveDate.getInstance().getArticles().toArray()));
