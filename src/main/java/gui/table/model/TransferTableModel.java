...
public class TransferTableModel extends MainTableModel {
    ...
    public TransferTableModel(String[] columns) {
        super(SaveDate.getInstance().getFilterTransfers(), columns);
    }

    @Override
    protected void updateData() {
        data = SaveDate.getInstance().getFilterTransfers();
    }

    // возвращаем значение ячейки по столбцу и строке
    @Override
